...
public class ClassImgDTO {
	...
	public ClassImgDTO(int classNum, String classPhoto1, String classPhoto2, String classPhoto3, String classPhoto4,
			String classPhoto5) {
		super();
	...
	public String toString() {
		return "ClassImgDTO [classNum=" + classNum + ", classPhoto1=" + classPhoto1 + ", classPhoto2=" + classPhoto2
